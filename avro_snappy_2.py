...
df1 = spark.read.format("com.databricks.spark.avro").load("/bigd37/avro_snappy_output2.avro")
rdd1 = df1.rdd
...
df2.write.format("com.databricks.spark.avro").save("/bigd37/avro_snappy_matrix2.avro")
